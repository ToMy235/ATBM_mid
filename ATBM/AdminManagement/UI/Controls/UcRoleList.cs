...
namespace OracleDBAdmin.UI.Controls
{
    public class UcRoleList : UserControl
    {
        ...
        private void InitializeUi()
        {
            ...
            lblHint = new Label
            {
                Text = "Theo dõi, tìm kiếm, tạo mới, chỉnh sửa và xóa các role trong hệ thống Oracle.",
                AutoSize = true,
            ...
            sectionGrid = CreateSectionPanel("Danh sách role hiện có", 520);
        ...
        private void InitializeFilterSection()
        {
            ...
            {
                Dock = DockStyle.Fill,
                Text = "Gợi ý: nhập tên role rồi bấm Tìm kiếm để lọc nhanh danh sách.",
